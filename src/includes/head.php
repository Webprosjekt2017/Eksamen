...
<head>
  ...
  <!-- PAGE SPECIFIC -->
    <?php
    if($_GET["destination"] == 'home' || $_GET["destination"] == 'map' || $_GET["destination"] == 'all' || !isset($_GET['destination'])) {
      echo '<script src="assets/js/filter.js"></script>';
    }
    if ($_GET["destination"] == 'home' || $_GET["destination"] == 'map' || !isset($_GET['destination'])) {
